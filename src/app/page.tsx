...
import { loadAllPatterns } from "./utils/patterns/index";
  ...
  useEffect(() => {
    const loadPatterns = async () => {
      try {
        ...
        console.error('Failed to load patterns:', error instanceof Error ? error.message : String(error));
        setPatternsLoaded(true); // Still show UI even on error
      }
    };
    loadPatterns();
  }, []);
