    ...
    >
      ...
      <div className="mb-8 sm:mb-10 lg:mb-12">
        <div className="text-center sm:text-left">
          ...
          >
            Click to preview or copy the code instantly
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-6">
        {gridPatterns.map((pattern) => (
          <div key={pattern.id} className="group relative">
            <div
              className={`relative aspect-square rounded-xl sm:rounded-2xl overflow-hidden bg-background shadow-sm hover:shadow-lg transition-all duration-300 hover:scale-[1.02] ${
            ...
            >
              ...
              <div className="absolute inset-0 cursor-pointer bg-gradient-to-t from-black/80 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-all duration-300 flex items-center justify-center p-3 sm:p-4">
                <div className="text-center transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
                  <h3 className="text-white font-semibold text-sm sm:text-base lg:text-lg mb-3 sm:mb-4 drop-shadow-lg">
                    {pattern.name}
                  </h3>
                  <div className="flex flex-col xs:flex-row gap-2 sm:gap-3 w-full xs:w-auto">
                    <Button
                      size="sm"
                      variant="secondary"
                      onClick={() => previewPattern(pattern.id)}
                    ...
                    <Button
                      ...
                      className={`shadow-xl cursor-pointer backdrop-blur-md gap-1 border-0 transition-all duration-200 hover:scale-105 text-xs sm:text-sm px-3 py-2 h-auto w-full xs:w-auto ${
                        copiedId === pattern.id
